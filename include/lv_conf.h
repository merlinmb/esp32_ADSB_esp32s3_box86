...
/*Set an address for the memory pool instead of allocating it as a normal array. Can be in external SRAM too.*/
    ...
    #define LV_MEM_CUSTOM_FREE(pointer) heap_caps_free(pointer)
    #define LV_MEM_CUSTOM_REALLOC(pointer, size) heap_caps_realloc(pointer, size, MALLOC_CAP_SPIRAM | MALLOC_CAP_8BIT)
#endif     /*LV_MEM_CUSTOM*/
...
#define LV_FONT_MONTSERRAT_20 1  /*diagnostic — remove once text rendering confirmed*/
